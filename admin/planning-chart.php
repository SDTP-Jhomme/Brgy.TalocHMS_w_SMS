                        ...
                        <el-main>
                            ...
                            <div class="card mb-4">
                                <div class="card-body text-primary">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <el-button type="primary" @click="openAddDrawer = true" size="small" icon="el-icon-s-data">History Logs</el-button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <el-drawer :visible.sync="openAddDrawer" :direction="direction" size="small" :before-close="closeAddDrawer">
                                <div class="container d-flex flex-column">
                                    <el-header height="40">
                                        <h1 class="mt-4">Family Planning Records Logs</h1>
                                        <div class="card mb-5">
                                            <div class="card-body text-primary">
                                                Barangay Taloc Online Health Record Management System <?php echo date("Y"); ?>
                                            </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <?php include("family-planning.php"); ?>
                                </div>
                            </div>
                        </el-main>
                    </el-container>
