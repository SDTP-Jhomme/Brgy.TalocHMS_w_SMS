                ...
                <main>
                    <el-container>
                        <el-header class="mt-4" height="40">
                            <h1 class="mt-4">Family Planning Table</h1>
                            <div class="card mb-4">
                        ...
                        <el-dialog :visible.sync="printDialog" width="80%" :before-close="closePrintDialog">
                            <div class="container">
                                <div class="mt-5" id="printTable">
                                    <?php include("./print-tables/planning-print.php") ?>
                                </div>
                            </div>
                            <span slot="footer" class="dialog-footer">
                            ...
                            <div class="container">
                                <div class="" id="printThis">
                                    ...
                                    <div style="border-bottom:3px solid black ;">
                                        <div class="my-3">
                                            <h4 class="fw-bold text-center mb-4" style="font-family:'Times New Roman', Times, serif;">DEMOGRAPHIC AND OTHER INFORMATION</h4>
                                        </div>
                                        ...
                                        <div class="row d-flex justify-content-md-between mb-4 ">
                                            <div class="col-auto">
                                                <label>Name of spouse: <span class="border-bottom-1 border-dark">{{viewPrenatal.spouse}}</span></label>
                                            </div>
                                            <div class="col-auto">
                                                <label>Spouse Address: <span class="border-bottom-1 border-dark">{{viewPrenatal.spouse_address}}</span></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="my-3">
                                        <h4 class="fw-bold text-center mb-4" style="font-family:'Times New Roman', Times, serif;">Family Planning Service Record</h4>
                                    </div>
                                    <div style="font-family:'Times New Roman', Times, serif;">
                                        <div class="mx-5 fs-5">
                                            <div style="border-bottom:3px solid black ;">
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label> <span class="fw-bold fs-6">MEDICAL HISTORY</label>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label>HEENT: <span class="border-bottom-1 border-dark">{{viewPrenatal.heent}}</span></label>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label> <span class="fw-bold fs-6">PHYSICAL EXAMINATION</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label>Blood pressure: <span class="border-bottom-1 border-dark">{{viewPrenatal.bp}}</span>mmHg</label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label>Weight: <span class="border-bottom-1 border-dark">{{viewPrenatal.weight}}</span>/kg</label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label>Pulse rate: <span class="border-bottom-1 border-dark">{{viewPrenatal.pr}}</span>/mm</label>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label>CHEST/HEART AND LUNGS/BREAST: <span class="border-bottom-1 border-dark">{{viewPrenatal.chLB}}</span></label>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-center">
                                                    <div class="col-auto">
                                                        <label>HEAD AND NECK</label>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label>Conjunctive: <span class="border-bottom-1 border-dark">{{viewPrenatal.conjunctive}}</span></label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label>Neck: <span class="border-bottom-1 border-dark">{{viewPrenatal.neck}}</span></label>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label>ABDOMEN: <span class="border-bottom-1 border-dark">{{viewPrenatal.abdomen}}</span></label>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label>THORAX: <span class="border-bottom-1 border-dark">{{viewPrenatal.thorax}}</span></label>
                                                    </div>
                                                </div>
                                                <div class="row d-flex justify-content-center">
                                                    <div class="col-auto">
                                                ...
                                                <div class="row d-flex justify-content-md-between">
                                                    <div class="col-auto">
                                                        <label>FEMALE: <span class="border-bottom-1 border-dark">{{viewPrenatal.femGenital}}</span></label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label>MALE: <span class="border-bottom-1 border-dark">{{viewPrenatal.maleGenital}}</span></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        new Vue({
            ...
            methods: {
                ...
                getData() {
                    axios.post("action.php?action=fetch_planning")
                        .then(response => {
