...
!(function (t, e) {
  ...
  function sn(n, r, o) {
    ...
    return (
      (_.run = function () {
        if (_.active || ("pre" === l && p && p._isBeingDestroyed))
          if (r) {
            var t = _.get();
            (c ||
              h ||
  ...
  var kn = Cn("beforeMount"),
    ...
    Nn = Cn("activated"),
    Pn = Cn("deactivated"),
    Dn = Cn("serverPrefetch"),
    Mn = Cn("renderTracked"),
    In = Cn("renderTriggered"),
    Ln = "2.7.8";
  ...
  function fo(t, e) {
    ...
    for (n = 0; n < t.length; n++)
      (r = t[n]).modifiers || (r.modifiers = lo),
        ...
        e._setupState &&
          e._setupState.__sfc &&
          (r.def = r.def || gr(e, "_setupState", "v-" + r.name)),
  ...
  function Ws(t, e) {
    ...
    if (t.staticInFor) {
      ...
      return n
        ? "_o(".concat(Js(t, e), ",").concat(e.onceId++, ",").concat(n, ")")
        : Js(t, e);
    }
    return qs(t, e);
  }
