<div class="w-70 lg">
    <el-container>
        ...
        <div class="body-card-form">
            ...
            <el-main>
                <!-- Patient Information -->
                <div v-if="this.currentRow" class="label-format d-flex flex-wrap justify-content-around">
                    <div class="w-25 mb-4">
                ...
                <el-form :model="family" :rules="familyRules" ref="family">
                    ...
                    <div class="row g-3 align-items-center mt-5">
                        ...
                        <div class="col-auto">
                            <el-form-item prop="purok">
                                <el-input size="medium" v-model="family.purok" clearable></el-input>
                            </el-form-item>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <el-form-item prop="barangay">
                                <el-input size="medium" v-model="family.barangay" clearable></el-input>
                            </el-form-item>
                        </div>
                    </div>
                    <!-- End -->
                    ...
                    <div class="">
                        ...
                        <div class="mb-4" :class="!currentRow.middle_name && !currentRow.suffix ? 'w-30' : 'w-20'">
                            <label class="m-0">FSN</label>
                            <el-input v-model="addPatient.fsn" size="small" clearable></el-input>
                        </div>
                        <div class="row g-3 align-items-center mt-5">
                            <div class="col-auto">
