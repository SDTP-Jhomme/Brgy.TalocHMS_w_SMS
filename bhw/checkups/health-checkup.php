<div class="w-80 ">
    <el-container>
        ...
        <div class="body-card-form">
            ...
            <el-main>
                <el-form :model="health" ref="health">
                            ...
                            <div class="w-85 d-flex justify-content-between flex-wrap">
                                <div class="w-50">
                                    <el-form-item label="Past Medical Family History" prop="history">
                                        <el-checkbox v-model="health.history" label="HPN"></el-checkbox>
                                        <el-checkbox v-model="health.history" label="DM"></el-checkbox>
                                        <el-checkbox v-model="health.history" label="Asthma"></el-checkbox>
                                        <el-checkbox v-model="health.history" label="Smoker"></el-checkbox>
                                    </el-form-item>
                                </div>
                                <div class="w-50">
